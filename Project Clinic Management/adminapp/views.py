...
def admin_dashboard(request):
    ...
    return render(request,'admin/admin-dashboard.html',{'a' :all_patient_count, 'b' : pending_patient_count, 'c' : rejected_patient_count, 'd' : accepted_patient_count,"allu" : all_doctors , 'user' : post})
